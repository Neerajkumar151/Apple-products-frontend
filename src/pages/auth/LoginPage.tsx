...
export default function LoginPage() {
  ...
  return (
    <div 
      ref={containerRef}
      className="min-h-screen pt-20 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-apple-gray-50 via-white to-apple-gray-50"
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8 sm:p-10 shadow-apple-lg border border-white/50">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="form-element pt-2">
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-14 rounded-xl bg-primary text-white font-medium text-body hover:bg-primary/90 transition-all duration-300 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 group"
              >
                {isLoading ? (
          ...
          <div className="form-element relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/80 text-apple-gray-300">or continue with</span>
            </div>
          </div>
          ...
          {/* Links */}
          <div className="form-element mt-8 text-center space-y-3">
            <Link 
              to="/forgot-password" 
              className="text-body-sm text-primary hover:underline transition-colors duration-200 block"
            >
        ...
        {/* Footer */}
        <p className="form-element mt-8 text-center text-caption text-apple-gray-300">
